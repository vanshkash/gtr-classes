          ...
          <div className="grid lg:grid-cols-2 items-center">
            ...
            <div className="p-8 lg:p-12">
              ...
              <p className="mt-6 text-slate-600 leading-8">
                GTR Classes was founded with a simple mission —
                to help teaching aspirants achieve their dreams through
                quality education, structured preparation, and
                affordable learning resources.
              </p>

              <p className="mt-4 text-slate-600 leading-8">
                Through expert guidance, premium notes, video lectures,
                and exam-oriented strategies, GTR Classes continues
                to support students preparing for PGT, TGT, KVS,
                NVS, DSSSB and other teaching examinations.
              </p>
